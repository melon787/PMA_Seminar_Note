...
we obtain the reverse. This establishes the theorem.
 \end{proof}
 \begin{theorem}
    A set $E$ is oopen if and only if its complement is closed.
 \end{theorem}
 \begin{proof}
...
(b) follows from (a), Theorem 2.22, and Theorem 2.23. We see that
\begin{align*}
    F_{\alpha} \text{ is closed} &\implies F_{\alpha}^c 
\end{align*}
\end{proof}