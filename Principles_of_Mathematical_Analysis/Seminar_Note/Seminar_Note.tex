...
Let $0$ and $1$ denote the additive and multiplicative identities, respectively. 
Then $0=(0,0)$ and $1=(1,0)$. 
...
\begin{align*}
    i^2=(0,1)(0,1)=(-1,0)>0.
\end{align*}
Since $(-1,0)+(1,0)=0$, $(-1,0)$ is the additive inverse of $(1,0)$. 
Since $1>0$ and if $x>0$ then $-x<0$ in any ordered field, we obtain
\[
(-1,0)=-(1,0)=-1<0.
\]
